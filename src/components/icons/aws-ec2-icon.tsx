...
export default function AwsEc2Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="SVGeyciVcvH" x1="0%" x2="100%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#c8511b"></stop>
          <stop offset="100%" stopColor="#f90"></stop>
        </linearGradient>
      </defs>
      <path fill="url(#SVGeyciVcvH)" d="M0 0h256v256H0z"></path>
      <path
        fill="#fff"
