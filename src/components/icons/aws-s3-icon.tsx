...
export default function AwsS3Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="SVG7R6tZwZW" x1="0%" x2="100%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#1b660f"></stop>
          <stop offset="100%" stopColor="#6cae3e"></stop>
        </linearGradient>
      </defs>
      <path fill="url(#SVG7R6tZwZW)" d="M0 0h256v256H0z"></path>
      <path
        fill="#fff"
