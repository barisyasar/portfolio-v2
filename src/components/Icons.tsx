const Icons = {
  react: ({ className = "size-8" }: { className?: string }) => (
    <svg
  ...
  node: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
      className={className}
  ...
  next: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 15 15"
  ...
  express: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      className={className}
  ...
  redux: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 128 128"
  ...
  bootstrap: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
      className={className}
  ...
  framerMotion: ({ className = "size-8" }: { className?: string }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      viewBox="0 0 24 24"
