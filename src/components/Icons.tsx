...
export const IyzicoIcon = ({
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.8 25.056v3.127a2.323 2.323 0 0 1-2.318 2.317c-.695 0-1.274-.232-1.621-.695"
    ></path>
    <path
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.8 21.117v3.823c0 1.274-1.043 2.317-2.318 2.317s-2.316-1.043-2.316-2.317v-3.823m24.689 5.992a2.27 2.27 0 0 1-2.261-2.261v-1.47a2.27 2.27 0 0 1 2.26-2.26h0a2.27 2.27 0 0 1 2.262 2.26v1.47a2.27 2.27 0 0 1-2.261 2.26m-17.788-5.991h4.438l-4.438 5.992h4.438"
    ></path>
    <circle cx={9.732} cy={18.348} r={0.75} fill="currentColor"></circle>
    <path
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.732 21.117v5.992m22.772-1.131c-.339.679-1.13 1.13-1.921 1.13h0a2.27 2.27 0 0 1-2.261-2.26v-1.47a2.27 2.27 0 0 1 2.26-2.26h0c.792 0 1.583.452 1.922 1.13"
    ></path>
    <circle cx={25.943} cy={18.348} r={0.75} fill="currentColor"></circle>
    <path
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M25.943 21.117v5.992"
    ></path>
  </svg>
);
...
export const FacebookIcon = ({
  ...
  >
    <path
      fill="#3d5a98"
      d="M0 0v16h16V0zm12.9 8.4h-2.1V14H8.7V8.4H7.2v-2h1.5V4.7c0-1.5.9-2.7 2.9-2.7c.8 0 1.4.1 1.4.1V4h-1.3c-.7 0-.8.3-.8.9v1.5H13z"
    ></path>
  </svg>
);
...
export const AhrefsIcon = ({
  ...
  >
    <path
      fill="#FF8800"
      d="M7.1,17.9h40.8v11.5l-15.3,1.2C7.8,32.3,0,38.9,0,57.3V61c0,13.5,9.4,21.6,23.9,21.6c11.5,0,18-2.7,26.1-11h1.3v8.8h16.3V0H7.1V17.9L7.1,17.9z M47.9,56.6c-5.1,5.1-12.6,8.4-18.9,8.4c-6.7,0-9.6-2.5-9.4-8.1c0.2-7.8,3-9.6,16-10.8L47.9,45C47.9,45,47.9,56.6,47.9,56.6z"
    />
  </svg>
);

export const SemrushIcon = ({
  className = 'size-8',
}: {
  className?: string;
}) => (
